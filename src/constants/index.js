...
export const HERO_CONTENT = `I am a passionate full-stack developer with a strong focus on crafting dynamic and scalable web applications. With 3 years of hands-on experience, I excel in both front-end and back-end technologies, including React.js, Node.js, Express.js, and MySQL. My expertise lies in building seamless, responsive user interfaces while ensuring robust server-side architecture. I am driven by a commitment to innovation and strive to deliver solutions that enhance business performance and provide exceptional user experiences.`;
